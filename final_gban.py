...
from tg_bot import dispatcher, OWNER_ID, SUDO_USERS, STRICT_GBAN
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) in SUDO_USERS:
        message.reply_text("lol my sudo users fighting each other ðŸ˜‚")
        return

    if int(user_id) in SUPPORT_USERS:
        message.reply_text(" sed someone trying to gban my support user *")
        return

    if user_id == bot.id:
        message.reply_text("-_- why whould i gban my self .")
        return
    ...
    message.reply_text("lets gban this user ")
...
def ungban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("This person has been un-gbanned and now you are safe !")
